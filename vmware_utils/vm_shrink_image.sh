...
# Project:      LUPIN
#
# Description:	Shrink a VMware VM image
#
...
#       Required:       awk cp fileutils sh tar vmrun
#       Optional:       ?
#
...
VM_SOURCEDIR="/var/lib/vmware/Virtual Machines"

# Destination directory where the shrinked image will be located (under ${VM_NAME})
VM_DESTDIR=${HOME}/tmp/VMimages
